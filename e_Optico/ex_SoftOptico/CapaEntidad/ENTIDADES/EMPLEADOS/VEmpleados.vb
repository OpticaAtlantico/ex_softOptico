Public Class VEmpleados
    Public Property _empleadoID As Integer
    ...
    Public Property _asesor As Boolean
    Public Property _gerente As Boolean
    Public Property _optometrista As Boolean
    Public Property _marketing As Boolean
