...
#Region "LAYOUT Y ESTILOS"
    ...
    Private Sub PrepararLayout()
        filtro = New TextboxFiltroUI() With {
            ...
            .IconColor = AppColors._cGris
        }

        dgvOrbital = New DataGridView() With {
            .Dock = DockStyle.Fill,
            .BackgroundColor = AppColors._cBlanco,
        ...
        paginador = New FlowLayoutPanel() With {
            ...
            .BackColor = AppColors._cBlancoOscuro,
        ...
        lblPaginaInfo = New Label With {
            .Text = "Página 1 de 1",
            .Font = New Font(AppFonts.Century, AppFonts.SizeSmall, AppFonts.Italic),
            .AutoSize = True,
    ...
    Private Sub PrepararEstiloVisualOrbital()
        ...
        .SelectionForeColor = AppColors._cTextoNormal,
        .Padding = New Padding(3)
    }

        dgvOrbital.RowTemplate.Height = 29
        dgvOrbital.GridColor = AppColors._cGridLine
    ...
    Public Sub NeutralizarFondoIconos(grid As DataGridView)
        For Each col As DataGridViewColumn In grid.Columns
            If TypeOf col Is DataGridViewImageColumn Then
                col.DefaultCellStyle.BackColor = AppColors._cBlanco
                col.DefaultCellStyle.SelectionBackColor = AppColors._cBlanco
                col.DefaultCellStyle.SelectionForeColor = AppColors._cBlanco
