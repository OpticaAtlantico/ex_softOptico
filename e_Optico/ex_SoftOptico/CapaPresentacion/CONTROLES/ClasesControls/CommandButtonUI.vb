...
#Region "DIBUJO"
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        ' ✏️ Dibujar texto (dejando espacio a la izquierda)
    ...
    Protected Overrides Sub OnResize(e As EventArgs)
        MyBase.OnResize(e)
        ' 📍 Reubicar icono solo al cambiar tamaño
        iconControl.Location = New Point(Me.Width - iconControl.Width - 12,
                                         (Me.Height - iconControl.Height) \ 2)
    End Sub
