...
Public Class TextBoxLabel2UI
    ...
    Private _panelBackColor As Color = Color.White
    ...
    Private _mensajeError As String = "Este campo no puede quedar vacío."
    ...
    Public Sub New()
        ...
        lblError.Font = New Font(_fontField.FontFamily, _fontField.Size - 1)
        lblError.Height = 20
    ...
    Public Property FontField As Font
        ...
        Set(value As Font)
            ...
            lblError.Font = New Font(value.FontFamily, value.Size - 1)
        End Set
    End Property
