...
Public Class DataGridViewGUI
    ...
    Private btnEnviar As New CommandButtonUI() With {
        .Texto = "Enviar",
    ...
    Private Sub dgvOrbital_CellClick(sender As Object, e As DataGridViewCellEventArgs)
        ...
        'Aqui es donde envio la información

        Dim filaSeleccionada As DataGridViewRow = dgvOrbital.Rows(e.RowIndex)
        Dim columnaSeleccionada As DataGridViewColumn = dgvOrbital.Columns(e.ColumnIndex)
    ...
    Public Property BEnviar As CommandButtonUI
        Get
            Return btnEnviar
        End Get
