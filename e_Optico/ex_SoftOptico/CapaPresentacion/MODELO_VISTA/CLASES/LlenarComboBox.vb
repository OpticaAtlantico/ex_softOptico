...
Public Class LlenarComboBox
    ...
    Public SQL_LOCALIDAD As String = "SELECT * FROM VCUbicaciones"
    ...
    Public Sub Cargar(combo As ComboBoxLayoutUI, sql As String, textField As String, valueField As String)
